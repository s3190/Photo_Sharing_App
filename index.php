  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    <style>
        ...
        .content {
            ...
            box-shadow: 0 0 5px #F2D7D5  ;
        }
    </style>
</head>
<body>
    <h1 style="color:#17202A">Welcome to Connect</h1>
    <div class="container">
        <div class="tab">
            <button class="tablink active btn btn-success" onclick="openTab(event,'signin')" id="link1">Login</button>
            <button class="tablink btn btn-success" onclick="openTab(event,'signup')" id="link2">Sign Up</button>
        </div>
        <div class="content">
